...
int knight_movements(int x, int y, int moves, int** visited_chess_board, int ROWS, int COLS, int first){
    // printf("%d, %d , moves = %d\n", x, y, moves);
    if (moves >= 0){
            if (first > 0){
            ...
            if ((x - 2 >= 0) && (x - 2 < ROWS) && (y + 1 >= 0) && (y + 1 < COLS)){
                knight_movements(x - 2, y + 1, moves - 1, visited_chess_board, ROWS, COLS, first);
            }
            // i - 2 , y - 1
            if ((x - 2 >= 0) && (x - 2 < ROWS) && (y - 1 >= 0) && (y - 1 < COLS)){
                knight_movements(x - 2, y - 1, moves - 1, visited_chess_board, ROWS, COLS, first);
            ...
            if ((x - 1 >= 0) && (x - 1 < ROWS) && (y + 2 >= 0) && (y + 2 < COLS)){
                knight_movements(x - 1, y + 2, moves - 1, visited_chess_board, ROWS, COLS, first);
            }
            // i - 1 , y - 2
            if ((x - 1 >= 0) && (x - 1 < ROWS) && (y - 2 >= 0) && (y - 2 < COLS)){
                knight_movements(x - 1, y - 2, moves - 1, visited_chess_board, ROWS, COLS, first);
...
int main(){
    int moves, initialX, initialY, ROWS, COLS, first = 0;
    ...
    knight_movements(initialX, initialY, moves, visited_chess_board, ROWS, COLS, first);
